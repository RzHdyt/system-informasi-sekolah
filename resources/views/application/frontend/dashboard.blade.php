    ...
    <div class="col-sm-12 col-lg-12">
        <div class="card col-sm-12 col-lg-12 mt-3 mb-2">
            <div class="card-body col-sm-12 col-lg-12">
                <h2 class="text-center">Jajaran Petinggi Sekolah</h2>
                <hr>
                <div class="row">
                    @foreach ($gurus as $guru)
                    @if ($guru['jabatan'] !== 'Guru' && $guru['jabatan']!== 'Kep-TU' && $guru['jabatan']!=='Guru-BK'&& $guru['jabatan']!=='Staf-TU'&& $guru['jabatan']!=='Penjaga-Sekolah'&& $guru['jabatan']!=='Satpam'&& $guru['jabatan']!=='Staf-Perpus'&& $guru['jabatan']!=='Staf-lab')
                ...
                {{-- <nav aria-label="Page navigation example" class="pr-5 pl-">
                    <div class="d-flex justify-content-between">
                        Total : {{ $gurus->count() }}
                        {{ $gurus->links() }}
                    </div>
                </nav> --}}
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15858.197518585263!2d108.2867002!3d-6.4518471!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xf4f0c790e8ff3930!2sSMP%20Nurul%20Halim!5e0!3m2!1sid!2sid!4v1623071661551!5m2!1sid!2sid" width="1030" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>
        </div>
